/**
 * JOOBIN Renovation Hub Proxy v12.1.2
 * - FIX: Removed malformed URL syntax (extra curly braces) from Notion and Gemini API calls that was causing all requests to fail.
 * - FEAT: Implemented payment forecast logic.
 * - FIX: Hardened the function against potential API failures.
 */
